...
class VendorOnboardRequestListScreen extends StatefulWidget {
  final bool isButtonsVisible;
  final String requestType;
  const VendorOnboardRequestListScreen(
      {super.key, required this.isButtonsVisible, required this.requestType});

  @override
  State<VendorOnboardRequestListScreen> createState() =>
      _VendorOnboardRequestListScreen();
}

class _VendorOnboardRequestListScreen
    extends State<VendorOnboardRequestListScreen> {
  @override
  void initState() {
    super.initState();
  }
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  Consumer<VendorOnBoardingListProvider>(
                  ...
                  FutureBuilder(
                      ...
                      if (snapshot.connectionState == ConnectionState.done) {
                        ...
                        if (snapshot.hasError) {
                          ...
                          var data = snapshot.data
                              as ISACVendorOnboardingRequestListClass;
                          if (data.returnStatus == 3) {
                            return const NoDataFountWidget();
                          } else if (data.returnStatus == 2) {
                            return Consumer<VendorOnBoardingListProvider>(
                              builder: (context, value, child) {
                                return value.displayList.isEmpty
                                    ? const NoDataFountWidget()
                                    : Expanded(
                                        child: VendorOnboardRequestListWidget(
                    ...
                    future: context
                        ...
                        .getvendoronboardRequestListData(requestJson),
                  ),
                ],
              ),
            ),
